...
{{-- 
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/user/wp-content/themes/ms-lms-starter-theme/favicon.png') }}" />
    ...
    <link rel='stylesheet' id='course_category_style_1-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_1dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
    <link rel='stylesheet' id='course_category_style_2-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_2dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
    <link rel='stylesheet' id='course_category_style_3-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_3dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
    <link rel='stylesheet' id='course_category_style_4-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_4dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
    <link rel='stylesheet' id='course_category_style_5-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_5dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
    <link rel='stylesheet' id='course_category_style_6-css' href="{{ asset('assets/user/wp-content/plugins/masterstudy-lms-learning-management-system/_core/assets/css/vc_modules/course_category/style_6dd8b.css?ver=3.5.16') }}"
        type='text/css' media='' />
</head>
...
<body>
    ...
    <!-- <script>
		...
		if (typeof authorization_data === 'undefined') {
			authorization_data = {
				'register_nonce': '49ef5a7c49',
				'instructor_nonce': '7d4eeda52d',
				'login_nonce': '05e25c6c7f',
				'restore_nonce': '48f1b115b2',
    ...
    CÁI NÀY DÙNG ĐỂ KHÔI PHỤC TÀI KHOẢN NHƯNG KHÔNG BIẾT SỬA NỀN ĐỂ SAU TÍNH 
    CÒN 1 ĐOẠN HTML NỮA
    -->
    ...
    <!-- <script type="text/javascript" id="wc-order-attribution-js-extra">
        ...
        var wc_order_attribution = {
            "params": {
                ...
                "session": 30,
                "base64": false,
                "ajaxurl": "https:\/\/titv.vn\/wp-admin\/admin-ajax.php",
    ...
    CÁI NÀY CŨNG CẦN ĐỔI ỦL Ẫ MỚI DÙNG ĐƯỢC-->
    <script type="text/javascript"
