...
<body>
    ...
    <div id="chatbot-box">
        ...
        <div id="chatbot-footer">
            <input type="text" id="chatbot-message" placeholder="Nhập câu hỏi..." onkeypress="if(event.keyCode == 13) sendChatbot()">
    ...
    <script>
        ...
        function sendChatbot() {
            ...
            fetch('/botman?message=' + encodeURIComponent(message), {
                method: 'POST',
                headers: {
            ...
            .then(res => res.json())
            .then(data => {
                // Sửa cách lấy phản hồi từ BotMan
                const reply = data.messages && data.messages.length > 0 ? data.messages[0].text : 'Không có phản hồi';
