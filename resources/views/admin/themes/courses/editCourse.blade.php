              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="level" class="form-control" id="level" value="{{ $course->level }}" required />
                  </div>

                  <div class="form-group">
                    <label for="lesson">Số bài học</label>
                    <input type="number" name="lesson" class="form-control" id="lesson" value="{{ $course->lesson }}" required />
                  </div>

                  <div class="form-group">
                    <label for="price">Giá</label>
                    <input type="number" step="0.01" name="price" class="form-control" id="price" value="{{ $course->price }}" required />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="total_time_finish" class="form-control" id="total_time_finish" value="{{ $course->total_time_finish }}" required />
                  </div>

                  <div class="form-group">
                    <label for="finish_time">Thời gian hoàn thành</label>
                    <input type="text" name="finish_time" class="form-control" id="finish_time" value="{{ $course->finish_time }}" required />
                  </div>
